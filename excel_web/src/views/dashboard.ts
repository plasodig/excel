  ...
  const body = html`
    ...
    <table>
      ...
      <tbody>
        ...
        (r) => html`
            <tr>
              <td><a href="/admin/excels/${r.id}"><strong>${r.title}</strong></a></td>
              <td>${r.category}</td>
              ...
              <td>
                <div class="row-actions">
                  <a class="btn" href="/admin/excels/${r.id}">Detail</a>
                  ${r.status === "draft"
            ? html`<form class="inline" method="post" action="/admin/excels/${r.id}/generate-all">
