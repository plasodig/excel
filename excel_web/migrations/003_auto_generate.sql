...
--
-- Apply ke remote D1:
--   wrangler d1 execute tutorial-db --remote --file=./migrations/003_auto_generate.sql
-- Apply ke local D1:
--   wrangler d1 execute tutorial-db --local  --file=./migrations/003_auto_generate.sql
